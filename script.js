...
//Компоненти з вкладками - Розділ з операціями
...
//Ефект зникнення елементів меню
...
//Завантаження low scale картинок
...
//переключання елемента-hamburger
